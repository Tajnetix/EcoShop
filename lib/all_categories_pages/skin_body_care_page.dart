...
class SkinBodyCarePage extends StatefulWidget {
  const SkinBodyCarePage({super.key});

  @override
  State<SkinBodyCarePage> createState() => _SkinBodyCarePageState();
}

class _SkinBodyCarePageState extends State<SkinBodyCarePage> {
  final supabase = Supabase.instance.client;
  List<Map<String, dynamic>> products = [];
  bool isLoading = true;

  /// 🔥 Skin & Body Care category ID
  final String categoryId = '5484e732-3955-4f46-9955-b365b36e9e5d';
